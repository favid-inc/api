...
# Políticas do Aplicativo FAVID

## Política De Segurança e Privacidade FAVID
...
## Termos de Uso do Site/Aplicativo FAVID
...
V. Uso do Site/Aplicativo e dos Serviços
...
Dados do setor jurídico: (a ser acordado)
...
Você usa o Site/Aplicativo e os Serviços por sua própria conta e risco. O Site/Aplicativo e os Serviços, incluindo qualquer vídeo FAVID, são fornecidos “como estão” e “conforme disponíveis”.
...
Você entende e concorda que nós não fornecemos o produto “vídeo FAVID”, o Site/Aplicativo e Serviços FAVID, é apenas uma ferraementa eletrônica para interligar Você ao Usuário Artista que é o fornecedor do vídeo personalizado. E por esse serviço de interlocução é cobrado uma taxa administrativa do Usuário Artista para a manutenção dessa ferramenta. Os serviços de cadastro e uso do Site/Aplicativo e Serviços FAVID é totalmente gratuito a você usuário Fã. Não definimos os valores dos produtos, apenas expomos as definições ofertadas pelo Usuário Artista que terá um valor mínimo. Ciente de tudo isso, celebramos estes Termos com você, conforme as limitações de responsabilidade estabelecidas nestes na presente.
...
XIV. Eleição de Foro Judicial Competente
...
XV. Política de Cancelamento e Ressarcimento & Política de
