...
export type ApplyForAffiliation = ApplyForAffiliationPost | ApplyForAffiliationGet;

export type ApplyForAffiliationPost = Action<
  {
...
export type ApplyForAffiliationGet = Action<
  {
    url: "/ApplyForAffiliation";
    method: "GET";
    params: {
